...
<div class="modal-backdrop" on:click|self={handleClose}>
  <div class="conflict-modal-card">
    <div class="conflict-header">
      ...
      <button class="btn-icon" on:click={handleClose} title="Cancel upload">
    ...
    {#if currentConflict}
      <p class="conflict-description text-body">
        A file named <strong class="file-highlight">{currentConflict.name}</strong> already exists in this folder.
      </p>
      ...
      <div class="file-comparison-grid">
        ...
        <div class="comparison-card existing">
          <div class="comparison-header">
            ...
            <span class="text-caption font-bold">Existing on server</span>
          </div>
        ...
        <div class="comparison-card incoming">
          <div class="comparison-header">
            ...
            <span class="text-caption font-bold">New upload</span>
          </div>
          <div class="comparison-details">
            <div class="detail-row">
              <span class="text-caption text-sub">Size:</span>
    ...
    <div class="conflict-actions">
      {#if isMultiConflict}
        <div class="batch-quick-actions">
          <button class="btn btn-secondary btn-sm" on:click={handleSkipAll}>Skip All</button>
      ...
      <div class="primary-choice-actions">
        <button class="btn btn-secondary" on:click={handleSkip}>
          {applyToAll ? 'Skip All Remaining' : 'Skip'}
        </button>
